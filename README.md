...
The goal is to uncover patterns in team performance, scoring trends, and disciplinary behavior using data-driven insights and visualizations.
...
🔥 Key Insights
Clear home advantage trend across seasons
Certain teams consistently exhibit higher aggression levels
Away teams tend to receive more cards on average
Goal distributions highlight evolving attacking patterns in modern football
📌 Visualizations
...
jupyter notebook
💡 Future Work
Build match outcome prediction models
Integrate xG (expected goals) data
Develop a Streamlit dashboard
Apply machine learning for team ranking & scouting
